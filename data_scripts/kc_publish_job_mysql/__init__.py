...
class PublishMySqlJob():

    def build_glue_python_job(self,glue_job_template,replace_from,replace_to):
    ...
    def main(self,args):
        ...
        glue_job_template_file_prefix = 'kc_publishing_job_mysql_template'
        ...
        try:
            ...
            #     output_folder_path = 'src/glue/publish'
            # if args.datasets is None:
            #     datasets =  'heartbeat_stats,service_endpoints_with_heartbeats' ## 'inbound_call' ## 'all'
                ...
                for dataset in dataset_list:
                    ...
                    if not dataset:
                        ...
                        for publish in response_publishing:
                            ...
                            ## Need to add in the jdbc connection in the publishing metadata table
                            catalog_database  = publish["analysis_catalog"]
                            catalog_dataset  = publish["name"]
                            jdbc_connection = 'kinect_atlas_dev_kinect_rds_mysql_instance'
                            dw_database = publish["dw"]
                            schema = publish["schema"]
                            schema_stage = f'{schema}_stage'
                            target_table = publish["name"]  ## This is both the Catalog dataset name and the target table name
                            ...
                            with open(glue_template_file,mode='r') as glue_template_file:
                                    ...
                                    glue_python_shell_job = self.build_glue_python_job(glue_job_template,replace_from,replace_to)
